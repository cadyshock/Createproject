...
print("WELCOME TO RESTAURANT MANAGEMENT! \n This program will allow you to manage your restraunt by tracking table usage and returning total revenue.\n It will return total revenue and tables served for the restaurant.")
